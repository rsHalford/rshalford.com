defmodule RSHalfordWeb.AdminAuth do
  use RSHalfordWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_rs_halford_web_admin_remember_me"
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      RSHalfordWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_admin:
      ...
      defmodule RSHalfordWeb.PageLive do
        use RSHalfordWeb, :live_view

        on_mount {RSHalfordWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{RSHalfordWeb.AdminAuth, :ensure_authenticated}] do
