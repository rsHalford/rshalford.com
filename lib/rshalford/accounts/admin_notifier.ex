defmodule RSHalford.Accounts.AdminNotifier do
  import Swoosh.Email

  alias RSHalford.Mailer
  ...
  defp deliver(recipient, subject, body) do
    email =
      new()
      |> to(recipient)
      |> from({"rshalford", "contact@rshalford.com"})
      |> subject(subject)
      |> text_body(body)
  ...
  @doc """
  Deliver instructions to reset an admin password.
  """
  ...
  @doc """
  Deliver instructions to update an admin email.
  """
